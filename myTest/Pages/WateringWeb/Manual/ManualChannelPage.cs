...
namespace TabNoc.Ooui.Pages.WateringWeb.Overview
{
	internal class ManualChannelPage : StylableElement
	{
		...
		public ManualChannelPage(ChannelData channel, ManualPage parent) : base("div")
		{
			...
			ValidationFeedback.AppendValidationFeedbackElements(durationMultiInputGroup, "", "Das Format der Dauer muss hh:mm:ss sein!", true);
			...
			ValidationFeedback.AppendValidationFeedbackElements(batchNameMultiInputGroup, "", "Der Name ist bereits vergeben", true);
